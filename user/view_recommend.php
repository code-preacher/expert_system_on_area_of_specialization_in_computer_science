...
$fg=mysqli_query($con,"select name from user_login where email='".$_SESSION['email']."' ");
$ff=mysqli_fetch_array($fg);
$idn=$ff['name'];


$qf=mysqli_query($con,"select * from recommendation where student_name='$idn' order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
